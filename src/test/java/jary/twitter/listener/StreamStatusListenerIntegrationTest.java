...
import jary.config.AppConfig;
import jary.config.WebConfig;
...
/**
 * test class utilizing {@link jary.twitter.listener.StreamStatusListener} to exercise some basic end-to-end functionality for
